...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.csrf(csrf -> csrf.disable()).cors(cors -> cors.configurationSource(corsConfigurationSource())) // 啟用 CORS
				...
				// Authorization rules
				.authorizeHttpRequests(request -> request.requestMatchers(SecurityWhitelist.ENDPOINTS).permitAll()
